...
def test_three_gpp_parser_parses_committed_fixture():
    ...
    assert cover.response_to_doc == "R5-234567"
    assert cover.response_to_title == "5G_eHealth WI status"
    assert cover.response_to_group == "RAN WG3"
    assert cover.release == "Release 17"
