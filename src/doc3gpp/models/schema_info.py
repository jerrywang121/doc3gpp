    ...
    "spec_doc": (
        ...
        TableSchema(
            ...
            fields=(
                ...
                FieldInfo("section_no", "str", True, "Section number, e.g. 5.1."),
                FieldInfo("section_title", "text", True, "Section title."),
                FieldInfo("table_no", "str", True, "Table number when the chunk sits inside a table."),
                FieldInfo("table_title", "text", True, "Table title when the chunk sits inside a table."),
